...
import { authenticateUser, getSavedCredentials, validateEmail } from '../services/auth.service';
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await authenticateUser(usernameOrEmail, password, rememberMe);
      
      // Update auth context with user data (pass email for consistency)
      await loginWithContext(usernameOrEmail, password);
