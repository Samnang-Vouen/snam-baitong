                ...
                <div className="mt-3">
                  <div className="row">
                    ...
                    <div className="col-6 mb-2">
                      ...
                      <div className="fw-semibold">{new Date(farmer.plantingDate).toLocaleDateString()}</div>
                    </div>
                    <div className="col-6 mb-2">
                      <small className="text-muted">{t('harvest_date')}</small>
                      <div className="fw-semibold">{new Date(farmer.harvestDate).toLocaleDateString()}</div>
                    </div>
                  </div>
                </div>
              </div>
