...
export default function CropCard({ crop, onDelete, onViewFarmer }) {
  ...
  if (crop.type === 'farmer') {
    return (
      <>
        <div className="text-decoration-none" onClick={() => onViewFarmer && onViewFarmer(crop.id)}>
            ...
            <div className="card-body" style={{ paddingTop: '1.5rem' }}>
              ...
              <div className="row small">
                <div className="col-6">
                  ...
                  <div className="fw-semibold">{formatDate(crop.plantingDate)}</div>
                </div>
                <div className="col-6">
                  <small className="text-muted">{t('harvest_date')}</small>
                  <div className="fw-semibold">{formatDate(crop.harvestDate)}</div>
                </div>
              </div>
            </div>
          </div>
