...
const STATUS_OPTIONS = [
  { value: 'well_planted', label: 'Well planted' },
  { value: 'not_planted', label: 'No longer planted' },
  { value: 'died', label: 'Plant has died' }
];
    ...
    <div className="crop-detail-wrapper">
      ...
      <div className="crop-detail-container">
          ...
          <div className="card-body p-5">
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <p className="crop-info-value-normal">🌱 {formatDate(crop.plantedDate)}</p>
              </div>
              <div className="col-md-6 mb-0">
                <p className="crop-info-row">{t('harvest_date')}</p>
                <p className="crop-info-value-normal">🌾 {formatDate(crop.harvestDate)}</p>
              </div>
              <div className="col-md-6 mb-0">
        ...
        {!publicMode && role === 'admin' && (
          <div className="card mb-4">
            <div className="card-body">
              <h5 className="mb-3">Update crop status</h5>
